...
const Table_User = lazy(() => import("./admin_template/Admin/Table_User"));
const Table_Payment = lazy(() =>
  import("./admin_template/Admin/Table_payment")
);
const Table_Product = lazy(() =>
  import("./admin_template/Admin/Table_product")
);
const Add_Product = lazy(() => import("./admin_template/Admin/Add_product"));
const Edit_produit = lazy(() => import("./admin_template/Admin/Edit_produit"));
const Add_conseilleur = lazy(() =>
  import("./admin_template/Super_admin/Add_conseilleur")
);
const Table_conseilleur = lazy(() =>
  import("./admin_template/Super_admin/Table_conseilleur")
);
const Edit_conseilleur = lazy(() =>
  import("./admin_template/Super_admin/Edit_conseilleur")
);
const Table_orders = lazy(() =>
  import("./admin_template/Super_admin/Table_orders")
);
// const Edit_product = lazy(() =>
//   import("./admin_template/Super_admin/")
// );
const Analyse_dashboard = lazy(() =>
  import("./admin_template/Super_admin/Analyse_dashboard")
);

const App = (props) => {
  console.log("ehheheeh", [props]);
        ...
        <div className="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
          ...
          <div className="app-main">
            <Router>
              ...
              >
                <SideBar dataUser={props.user} />

                <Switch>
                  <Route exact path={"/Analyse"} component={Analyse_dashboard} />

                  <Route path={"/Table_user"} component={Table_User} />
                  <Route path={"/Table_Payment"} component={Table_Payment} />
                  <Route path={"/Table_Product"} component={Table_Product} />
                  <Route path={"/Add_Product"} component={Add_Product} />
                  <Route path={"/Edit_produit/:id"} component={Edit_produit} />
                  <Route
                    path={"/Add_conseilleur"}
                    component={Add_conseilleur}
                  />
                  <Route
                    path={"/Table_conseilleur"}
                    component={Table_conseilleur}
                  />
                  <Route
                    path={"/Edit_conseilleur/:id"}
                    component={Edit_conseilleur}
                  />
                  <Route path={"/Table_orders"} component={Table_orders} />
                </Switch>
              </Suspense>
            </Router>
          </div>
              ...
              <ScrollToTop>
                ...
                >
                  <Switch>
                    ...
                    <Route
                      exact
                      path={process.env.PUBLIC_URL + "/cb"}
                      component={Cbot}
                    />
